//! Live appearance state for the app (#309): the [`Metrics`] and
...
/// scales. At 13 logical px, every metric derives the same relative type
/// scale; [`points`] converts a metric
...
mod tests {
    ...
    fn default_metrics_match_the_frontend_base() {
        ...
        // 13 DIP is the 9.75 pt Segoe UI body the app has always used.
