//! Flattens the play history into day groups for rendering.
//!
...
pub(super) fn build_rows(entries: &[HistoryEntry], now: i64) -> Vec<Row<'_>> {
...
fn day_label(played_at: i64, now: i64) -> String {
